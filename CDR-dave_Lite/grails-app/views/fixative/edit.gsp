...
<html>
	...
	<body>
		<a href="#edit-fixative" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-fixative" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:fixativeInstance, action:'update']" method="PUT" >
