...
<div id ="hint" style="display:none">
  ...
  <div class="message">    
      ...
      <h3>All Field Search</h3>
        <ul>
                <li>Search by Case ID <i>(BPS-000351)</i></li>
                <li>Search by Candidate ID <i> (BPS-D076D8E4-C)</i> </li>
                <li>Search by title <i>(CI04546-V)</i></li>
                <li>Search by organization <i>(UUU)</i></li>
                ...
                <li>Search by multiple key words
                  <ul>
                    <li>AND <i>(UUU active)</i></li>
                    <li>OR <i>(UUU OR active)</i> </li>
                  </ul>
                </li>
        </ul>
      <br>
      ...
      <ul>
        <li>Syntax: [field]:[value]<i>(caseId:BPS-000351)</i></li>
        <li>Available fields
          <ul>
