<div class="message">    
      ...
      <ul>
        <li>Syntax: [field]:[value]<i>(tissueName:Lung)</i></li>
        <li>Available fields
          <ul>
            <li>CaseRecord: caseId, caseDateCreated </li>
          <li>CandidateRecord:candidateId, candidateDateCreated </li>
            ...
            <li>TissueType: tissueName, tissueCode</li>
            
          </ul>
         
        </li>
        <li>Date range search <i>(caseDateCreated:[2015-09-01 TO 2015-10-01])</i> </li>
