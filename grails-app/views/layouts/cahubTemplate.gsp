...
<g:if test="${homeLink == null || homeLink == ''}" ><g:if test="${session.org?.code == 'OBBR'}" ><g:set var="homeLink" value="/cdrlite/home/" /><g:set var="homeTitle" value="caHUB" /></g:if> <g:else><g:set var="homeLink" value="/cdrlite/home" /><g:set var="homeTitle" value="caHUB" /></g:else></g:if>
...
<%--
                  <ul class="gray">
                    ...
                    <g:if test='${session.authorities?.contains("ROLE_NCI-FREDERICK_CAHUB_DM") || session.authorities?.contains("ROLE_NCI-FREDERICK_CAHUB_LDS") || session.authorities?.contains("ROLE_NCI-FREDERICK_CAHUB_SUPER") || session.authorities?.contains("ROLE_ADMIN")}'>
                     ...
                     <g:if test='${session.authorities?.contains("ROLE_NCI-FREDERICK_CAHUB_QM") || session.authorities?.contains("ROLE_NCI-FREDERICK_CAHUB_SUPER") || session.authorities?.contains("ROLE_ADMIN")}'>
