...
<html>
	...
	<body>
		<a href="#list-fixative" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-fixative" class="content scaffold-list" role="main">
