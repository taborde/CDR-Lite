...
<html>
	...
	<body>
		<a href="#edit-candidateRecord" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-candidateRecord" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:candidateRecordInstance, action:'update']" method="PUT" >
