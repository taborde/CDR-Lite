...
<html>
    ...
    <%--
        ...
        <script type="text/javascript">
            var paramVals0 = "${params.get("param"+0)}";
            <g:each in="${urlparamsArray}" status="i" var="urlparamsStringValue">
              var ${urlparamsStringValue} = "${params[urlparamsStringValue]}";
            </g:each>
            ${params?.appsettingused?("var " + params?.appsettingused + " = " + appsettingused + ";"):""} 
            ${controllerData?("var controllerData = "+controllerData+";"):""}
        </script>
    </head>
    <body>
