...
<html>
	...
	<body>
		<a href="#edit-caseRecord" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-caseRecord" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:caseRecordInstance, action:'update']" method="PUT" >
